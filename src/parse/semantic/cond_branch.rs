...
pub fn make_if_else_node(tokens: Vec<token::Token>, index: &mut i32) -> Option<node::CalculNode> {
...
pub fn make_else_node(tokens: Vec<token::Token>, index: &mut i32) -> node::CalculNode {
